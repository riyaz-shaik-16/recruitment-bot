...
const Result = ({result}) => {
  ...
  <h2 className="text-3xl font-bold text-mercury-400 mb-6 flex items-center gap-3">
    <span className="bg-gradient-to-r from-mercury-400 to-mercury-200 bg-clip-text text-transparent">
      Interview Evaluation
    </span>
    <svg className="w-8 h-8 text-mercury-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <div className="space-y-6">
    <div className="p-4 bg-gray-700/30 rounded-xl hover:bg-gray-700/50 transition-colors">
      <div className="flex items-center gap-3 mb-2">
        <svg className="w-6 h-6 text-mercury-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
